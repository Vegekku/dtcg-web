...
// August, 2025
    ...
    // Event Pack 8 --- eventpack8
    {
        ...
        "name": "Event Pack 8",
        "release": "August - September, 2025",
        "url": "bandaitcgplusURL/P/e_EP8_setID-cardIDparallel_d.png",
        "cards": {
            "P-164": "",
            "P-165": "",
            "P-166": "",
...
// September 19, 2025
    // Extra Booster Sinister Order [EX10] --- ex10
    {
        ...
        "total": 74,
        "url": "bandaitcgplusURL/EX10/e_setID-cardID_D.png",
        "add_zero": 3,
        // "pack": "https://static.wikia.nocookie.net/digimoncardgame/images/b/b3/BT-15-Booster_Pack-EN.png",
        "playmat": "",
        "color": {
            ...
            "green": [1,16,20],
            "green-black": [23],
            "green-purple": [15,"17-19",21,22],
            "black": [2,3,24,25,28,29,32,33,35,36,62,63,69,70],
            "black-yellow": [30],
            "black-purple": [26,27,31,34],
            "black-white": [73],
            "purple": [4,5,"37-40",43,44,46,48,49,"56-58",60,"65-67"],
            "purple-red": [42,47,53],
            "purple-yellow": [41,52,71],
            "purple-green": [54],
    ...
    // Extra Booster Sinister Order [EX10] - Alternatives --- ex10_alts
    {
        ...
        "release": "September 19, 2025",
        "url": "bandaitcgplusURL/EX10/e_setID-cardIDP_D.png",
        "cards": {
            "EX10-009": "",
            "EX10-010": "",
            "EX10-011": "",
    ...
    // Extra Booster Sinister Order [EX10] - Limited Cards --- ex10_limited
    {
        ...
        "release": "September 19, 2025",
        "url": "bandaitcgplusURL/EX10/e_setID-cardIDLP_D.png",
        "cards": {
            "EX10-001": "",
            "EX10-002": "",
            "EX10-003": "",
    ...
    // Extra Booster Sinister Order [EX10] - Special Cards --- ex10_special
    {
        ...
        "release": "September 19, 2025",
        "url": "bandaitcgplusURL/EX10/e_setID-cardIDparallel_D.png",
        "cards": {
            "EX10-010": "P2",
            "EX10-023": "SP",
            "EX10-059": "SP",
    ...
    // Extra Booster Sinister Order [EX10] - Legend Pack --- ex10_legend_pack
    {
        ...
        "release": "September 19, 2025",
        "url": "bandaitcgplusURL/EX10/e_setID-cardIDPR_D.png",
        "cards": {
            "BT8-108": "",
            "BT15-070": "",
            "LM-016": "",
...
// October 2025
    // Limited Card Pack BILLION BULLET --- lm03
    {
        ...
        "url": "bandaitcgplusURL/LM06/e_setID-parallel_D.png",
        "cards": {
            "LM-045": "45",
            "LM-046": "46",
            "LM-047": "47",
    ...
    // Limited Card Pack BILLION BULLET - Alternatives --- lm03_alts
    {
        ...
        "release": "October 2025",
        "url": "bandaitcgplusURL/LM06/e_setID-cardIDLM_D.png",
        "cards": {
            "BT16-082": "",
            "BT16-101": "",
            "BT19-074": "",
    ...
    // Limited Card Pack BILLION BULLET - Reprints --- lm03_reprints
    {
        ...
        "release": "October 2025",
        "url": "bandaitcgplusURL/LM06/e_setID-cardIDparallel.png",
        "cards": {
            "BT3-008": "LM_D",
            "BT3-062": "LM_D",
            "BT11-032": "LM_D",
...
// October 24, 2025
    // Booster Hackers' Slumber [BT-23] --- bt23
    {
        ...
        "total": 102,
        "url": "bandaitcgplusURL/BT23/Same_setID-cardID_D.png",
        "add_zero": 3,
        // "pack": "https://static.wikia.nocookie.net/digimoncardgame/images/b/b3/BT-15-Booster_Pack-EN.png",
        "playmat": "",
        "color": {
            "red": ["5-9","11-15",78,91],
            "red-black": [10],
            "blue": [1,16,18,19,23,79,92,93],
            "blue-red": [22],
            "blue-yellow": [25,80],
            "blue-green": [21],
            "blue-purple": [17,20],
            "blue-white": [24],
            "yellow": [28,31,34,81,82,94],
            "yellow-red": [35,36],
            "yellow-blue": [27],
            "yellow-green": [26,29],
            "yellow-black": [30,32,33],
            "yellow-purple": [102],
            "green": [2,39,40,44,46,84,95],
            "green-red-blue": [47],
            "green-yellow": [37,41,101],
            "green-black": [38,42,43,45,83],
            "black": [3,49,52,53,"55-59",85,96],
            "black-red": [48,51,60,86],
            "black-blue": [54],
            "black-yellow": [50],
    ...
    // Booster Hackers' Slumber [BT-23] - Alternatives --- bt23_alts
    {
        ...
        "release": "October 24, 2025",
        "url": "bandaitcgplusURL/BT23/Same_setID-cardIDparallel.png",
        "cards": {
            "BT23-013": "P_D",
            "BT23-024": "P_D",
            "BT23-045": "P_D",
    ...
    // Booster Hackers' Slumber [BT-23] - Special Cards --- bt23_special
    {
        ...
        "release": "October 24, 2025",
        "url": "bandaitcgplusURL/BT23/Same_setID-cardIDSP_D.png",
        "cards": {
            "BT23-081": "",
            "BT23-084": "",
            "BT23-085": "",
    ...
    // Booster Hackers' Slumber [BT-23] - Box Promotion Pack --- bt23_boxtopper
    {
        ...
        "release": "October 24, 2025",
        "url": "bandaitcgplusURL/BT23/Same_BT23-cardIDparallel.png",
        "cards": {
            "BT23-017": "P_D",
            "BT23-037": "P_D",
            "BT23-040": "P_D",
